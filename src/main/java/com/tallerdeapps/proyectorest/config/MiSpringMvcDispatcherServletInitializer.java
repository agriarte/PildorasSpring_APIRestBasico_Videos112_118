package com.tallerdeapps.proyectorest.config;
...
public class MiSpringMvcDispatcherServletInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    // Tambiï¿½n pueden contener definiciones de bean. Suelen definir configuraciones relacionadas con la capa web: servletdispatcher, controladores, viewresolver
    @Override
